...
* [x] Joint: Bound method: data for all tasks are trained at once, an upper bound for the method </br>（Joint_mix means all tasks data mixed in batch, Joint_loader means the consistent proportion of data from each task in a batch）
