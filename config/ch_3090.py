common=dict(
    exp_name="CRNN_ch_der_baseline",  # Where to store logs and models
    il="der",  # joint_mix ｜ joint_loader | base | lwf | wa | ewc ｜ der  | ems
    memory="random", # None | rehearsal | random | bag | score | loss_max | test (just for ems) |large
    memory_num=2000,
    batch_max_length = 25,
    imgH = 32,
    imgW = 256,
...
train = dict(
    ...
    workers=4,
    ch_list = None,
    lan_list = ["LSVT","CTW","ReCTS","ArT","RCTW"],
    # lan_list=["Chinese","Latin","Japanese", "Korean", "Arabic", "Bangla"],
    train_data="../../../test/ztl/IL/IL_CHSTR/train",
    valid_data="../../../test/ztl/IL/IL_CHSTR/test",
    select_data=["../../../test/ztl/IL/IL_CHSTR/train"],
    valid_datas=["../../../test/ztl/IL/IL_CHSTR/test"],
    # select_data="/",
