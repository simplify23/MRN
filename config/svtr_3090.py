common=dict(
    exp_name="SVTR_ems_random_baseline",  # Where to store logs and models
...
train = dict(
    ...
    lan_list=["Chinese", "Latin","Japanese", "Korean",  "Arabic", "Bangla","Symbols","Hindi"],
    ...
    valid_datas=["../../../test/ztl/IL/MLT17_IL/test_2017","../../../test/ztl/IL/MLT19_IL/test_2019"],
    # train_data="../dataset/chinese",
    # valid_data="../dataset/chinese",
    # select_data="/",
    select_data=["../../../test/ztl/IL/MLT19_IL/train_2019"],
    batch_ratio="0.5-0.5",
