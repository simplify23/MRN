common=dict(
    exp_name="CRNN_test",  # Where to store logs and models
    il="joint_mix",  # joint_mix ｜ joint_loader | base | lwf | wa | ewc ｜ der  | ems
...
train = dict(
    ...
    valid_datas=["../dataset/MLT2017/test_2017","../dataset/MLT2019/test_2019"],
